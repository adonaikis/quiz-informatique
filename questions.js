export const Questions = [
    ...
    {
      question: 'Quelle méthode java nous permet de séléctionner des données de manière aléatoire ?',
      answers: ['random()', 'reduce()', 'shuffle()'],
      correct: 'shuffle()',
    },
    {
      question: 'En informatique, comment se nomme ce symbole | ?',
      answers: ['slash', 'pipe', 'anti-slash'],
      correct: 'pipe',
    },
    {
    ...
    {
      question: 'Quelle méthode transforme une chaîne de caractères en nombre entier ?',
      answers: ['parseInt', 'parseFloat', 'typeOf'],
      correct: 'parseInt',
    },
    {
    ...
    {
      question: 'Quel est le nom de la fonction qui permet de répéter une action à intervalles réguliers ?',
